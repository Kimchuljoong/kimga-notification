...
public class LikeUserNotificationResponse extends UserNotificationResponse {
    ...
    @Schema(description = "좋아요한 사용자 총 수")
    private final long userCount;

    @Schema(description = "게시글 이미지")
    private final String postImageUrl;

    public LikeUserNotificationResponse(String id, NotificationType type, Instant occurredAt, String userName, String userProfileImage, long userCount, String postImageUrl) {
